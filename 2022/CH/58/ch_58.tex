...
\begin{table}[htbp]
	...
	\input{2022/CH/58/tables/par.tex}
	\caption{Parameters}
	\label{tab:parameters_ch58_22}
\end{table}
\begin{figure}[htbp]
...
\end{align}
From \tabref{tab:parameters_ch58_22},
\begin{align}
...
\centering
\input{2022/CH/58/tables/gen_routh.tex}
\caption{Routh Array}
\label{tab:generalroutharray_ch58_22}
\end{table}
\newline
From \tabref{tab:generalroutharray_ch58_22}:

\begin{table}[htbp]
\setlength{\extrarowheight}{8pt}
\centering
\input{2022/CH/58/tables/routh.tex}
\caption{}
