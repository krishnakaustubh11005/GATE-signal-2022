...
\begin{enumerate}
  ...
  \begin{figure}[ht!]
    \centering
    \input{2022/PH/11/figs/option1.tex}
    \label{fig:ap13}
\end{figure}
  \item[(B)]  
  \begin{figure}[ht]
    \centering
    \input{2022/PH/11/figs/option2.tex}
    \label{fig:ap06}
\end{figure}
  \item[(C)] 
  \begin{figure}[ht]
    \centering
    \input{2022/PH/11/figs/option3.tex}
    \label{fig:ap03}
\end{figure}
  \item[(D)] 
   \begin{figure}[ht]
    \centering
    \input{2022/PH/11/figs/option4.tex}
    \label{fig:ap16}
\end{figure}
\end{enumerate}
